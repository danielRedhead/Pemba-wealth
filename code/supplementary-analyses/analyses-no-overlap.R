...
fit <- fit_latent_network_model( data=dat,
      ...
      target_regression = ~ 1, 
      dyad_regression = ~ Wealth_Distance + Relatedness + Distance,
...
save.image(file = "./3-analyses/results_no_overlap.RData")
write.csv(est_net, "./3-analyses/estimated_network_no_overlap.csv")